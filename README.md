...
StrpTK has found its best uses in dynamic web applications and is very well suited to that environment.  It won't replace static HTML in your apps, but it will suppliment and empower dynamic applications.
