 ...
 */
 (function() {
  ...
  strap.Component = strap.Base.extend(
      /**
       * @lends Component#
       */
      {
         ...
         * If attributes is an Array, it will be used as the list of children for the resulting
         * Component.
         ...
         *
         * @property {Object[]} children    This component's children.
         ...
         *
         * @param {Object} [attributes={}]  Values to apply to this object.  All values supplied are
         *                                  applied to the created object
         * @param {Object} [options={}]     Passed to the initialize function (currently unused by any
         *                                  default component)
         *
         * @see Base
         */
        ...
        /**
         * Sets the value of a field, only if it hasn't been defined on this object.
         * That is, it defines the value if hasOwnProperty(field) is false.
         *
         ...
         *  By default, Components only return the contents field in the supplied args
         *
         ...
         * @param {String} args.contents  The contents and compiled children of this Component
         *
         * @returns {String} Returns args.contents
         */
        ...
        get : function(index) {
          ...
          throw new TypeError("argument to `get` must be a string or number.");
        },

        /**
         * Sets the child at the given index or the field with the given key to
         * newValue.  In the case of children, checkIfRenderable is called on the
         * object before assignment.
         *
         * @param {String|Integer} index  The index of the child or key of the
         *                                field to change.
        ...
        set : function(index, newValue) {
          if(_.isUndefined(newValue)) {
            console.warn('`set` called without a newValue.');
            console.trace();
          }
          ...
          switch(typeof(index)) {
            ...
            case "number":
              return (this.children[index] = this.checkIfRenderable(newValue));
          }

          throw new TypeError("First argument to `set` must be a string or number.");
        },
